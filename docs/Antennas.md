...
Use [cellmapper](https://www.cellmapper.net/) to find out more about your region. First set your location, then select your carrier and 4G - LTE as network. In the Band dropdown, you can already see the bands your provider is using in your selected area.

> E.g.: Location set to "Vienna", Provider set to "A1 Telekom Austria - Austria - 2321", Network set to "4G - LTE". Bands Dropdown shows B1, B3, B7 and B20 - so those are the bands you will be interested in. But you can check in with finer granularity: Select the specific bands and see how many nodes are still left on the map.
